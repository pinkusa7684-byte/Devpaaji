        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {filteredServices.map((service, index) => {
            return (
              <div
                key={service.id}
                className="bg-white rounded-2xl border border-slate-200/90 hover:border-blue-300 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col justify-between overflow-hidden group hover:-translate-y-1"
              >
                <div className="p-6 sm:p-7">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    {service.badge && (
                      <span className="text-[11px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-slate-100 text-slate-700 border border-slate-200/70">
                        {service.badge}
                      </span>
                    )}
                  </div>
                ...
                <div className="p-6 pt-0 bg-white">
                  <div className="flex items-center gap-2 pt-4 border-t border-slate-100">
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-blue-50/80 hover:bg-blue-100 text-blue-900 font-semibold text-xs transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-[#0B1528] hover:bg-blue-950 text-white font-semibold text-xs transition-colors shadow-sm"
                    >
