    ...
    <section className="bg-white border-y border-slate-200/80 py-8 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-50 border border-slate-200 text-xs text-slate-700 font-medium">
            <Award className="w-4 h-4 text-amber-500" />
            <span>AMFI Registered Mutual Fund Distributor • <strong className="font-mono text-slate-900">ARN-358845</strong></span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4">
          {TRUST_INDICATORS.map((indicator) => (
            <button
              ...
              className="p-4 rounded-xl bg-slate-50/70 hover:bg-white border border-slate-200/80 hover:border-blue-300 hover:shadow-sm transition-all text-left group flex flex-col justify-between"
            >
              <div>
                <div className="w-10 h-10 rounded-lg bg-white border border-slate-200/60 flex items-center justify-center mb-3 group-hover:scale-105 transition-transform">
              ...
              <div className="mt-3 pt-2 border-t border-slate-100 flex items-center text-[11px] font-semibold text-blue-700 opacity-80 group-hover:opacity-100">
                <span>Explore</span>
